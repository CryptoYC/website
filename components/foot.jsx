...
const iconArr = ['facebook', 'github', 'medium',  'telegram', 'twitter', 'weibo']
        ...
        <div className="foot">
          ...
          <Row>
            ...
            <Col sm="2">
              ...
              <div className="content">
                <Link href='/benchmark'><a className='item'> {t('benchmark')}</a></Link>
                {/* <Link href='/community'><a className='item'> {t('community')}</a></Link> */}
                <Link href='/investment'><a className='item'> {t('investment')}</a></Link>
                <Link href='https://cryptoyc.github.io/'><a className='item'> {t('blog')}</a></Link>
              </div>
            </Col>
            <Col sm="2">
              <div className="title ">
              ...
              <div className="content">
                ...
                <Link href='/group'><a className='item'> {t('group')}</a></Link>
                <Link href='/joinUs'><a className='item'> {t('joinUs')}</a></Link>
                {/* <Link href='/aboutUs'><a className='item'> {t('aboutUs')}</a></Link> */}
              </div>
            </Col>
            <Col sm={{span:"4",offset:0}}>
              ...
              <Row className='icon_list '>
                ...
                {
                  iconArr.map(key => {
                    return <Col sm='3' className='icon_item'>
                      <a href={imageObj[key]}>
          ...
          <Row className="logo">
            <Col  sm={{ span: 4 }} >
              @2019 CryptoYC.ALL RIGHTS Reserved
              </Col>
            <Col className="column_center" sm={{ span: 2 }}>
