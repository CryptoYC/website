...
const AboutUs = ({t}) => {
    return <div className="about_us">
        ...
        <div className="contain_body">
            <img src={i18n.language=='en'?"/static/images/aboutUs/1_en.png":"/static/images/aboutUs/1.png"} alt="" />
            <Row>
                <Col sm={{ span: 5 }} className="border-bottom flex_space">
                    <div className="text">{t('label_1')}</div>
                    <Link href="/contactUs">
                        <a >
                        <Row>
                ...
                <Col sm={{ span: 5, offset: 2 }} className="border-bottom flex_space">
                    <div className="text">{t('label_2')}
                    </div>
                    <Link href="/community">
                        <a>
                        <Row >
                            <Col className="column_center label">{t('button_2')}</Col>
                            <img src="/static/images/aboutUs/2.png" alt="" />
                        </Row>
                        </a>
                    </Link>
