...
class C extends React.Component {
    ...
    render() {
        const { show } = this.state
        const {t}=this.props
        return <div className="active" onMouseEnter={this.onMouseEnter} onMouseLeave={this.onMouseLeave}>
    ...
    return arr.map((e, index) => {
        return <React.Fragment><Col key={e} sm="2" className="column_center row_center icon_padding">
            ...
            {length < 5 && (index + 1 == length) && spaceArr.map(ee => {
                return <Col key={`${index}_${ee}`} sm="2" className="column_center row_center icon_padding">
       ...
       return  <div className="group">
            ...
            <div className="list_item">
                ...
                <Row className="flex_space-between">
                    <GetIcon arr={[3, 4, 5, 6, 7]} t={t}></GetIcon>
                </Row>
                <Row className="flex_space-between">
                <GetIcon arr={[ 9,  11, 12,14]} t={t}></GetIcon>
            ...
            <div className="list_item">
                ...
                <Row className="flex_space-between">
                <GetIcon arr={[15, 16, 17,21, 22 ]} t={t}></GetIcon>
                   
                </Row>
                <Row className="flex_space-between">
                <GetIcon arr={[ 23, 24]} t={t}></GetIcon>
