...
import { withNamespaces } from 'react-i18next';
 class ProjectSubmitted extends Component {
    ...
    render() {
        ...
        const {t}=this.props
        return <div className="projectSubmitted">
            <Head></Head>
            <MyNav></MyNav>
            <div className='head'> <img src="/static/images/benchmark/12.gif" alt="" /></div>
            ...
            <Modal show={isSubmitShow} onHide={this.closeModal}>
                ...
                <Modal.Body>
                    <div className="model">
                        <div style={{textAlign:'center'}}><img src="/static/images/benchmark/15.png" alt="" /></div>
                        <div className="title">资料提交成功</div>
                        <div className='text'>CryptoYC将会在三个工作日内联系您商讨尽调事宜</div>
                        <div onClick={this.closeModal} className="backHome">返回首页</div>
                    </div>
